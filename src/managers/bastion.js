...
Bastion.prototype.distributeChannel = function(bip, channel_id, content_type, encoding, exports, client, content_parts) {
  ...
  if (!exports[channel_id]) {
	...
	// handle channels keyed to UUID
	if (channel_id.isUUID) exports[channel_id] = app._.clone(exports.local, {} );

	// handle channels keyed to pod.action
	else {
      ...
      tokens.forEach(function(token) {
        ...
        exports[ptr] = app._.clone(exports.local, {} );
